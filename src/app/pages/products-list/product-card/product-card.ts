...
@Component({
  ...
  template: `
    <div class="bg-white shadow-md border-0 rounded-xl p-6 flex flex-col gap-6 relative">
      <div class="mx-auto">
         ...
         <span class="absolute top-2 right-3 text-sm font-bold" [class] = "product().stock ? 'text-green-600' : 'text-red-500'" >
